...
<img src="modules/webpay/web-pay-adq.gif" alt="WebPay"/>
...
<tr>
  ...
  <td  align="left" >Productos tienda <b><a href="order-detail.php?id_order={$orden_compra}" >Ver detalle del pedido</a></b></td>
</tr>
<tr>
  <td  align="left" >Revise Restricciones con respecto a  devoluciones y reembolsos.</div></td>
  <td  align="left" ><div align="left">
  <a href="content/9-terminos-y-condiciones?content_only=1&amp;TB_iframe=true&amp;width=450&amp;height=500&amp;thickbox=true" onclick="void window.open('content/9-terminos-y-condiciones?content_only=1&amp;TB_iframe=true&amp;width=450&amp;height=500&amp;thickbox=true', '_blank', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no');return false;">Ver detalle</a>
